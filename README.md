...
когда длительность указанного в новом сеансе фильма больше продолжительности самого сеанса, когда не найдены указанные пользователем фильмы, сеансы, места, когда вводится неположительное значение продолжительности фильма.
## Примечание
Диаграммы классов и прецендентов хранятся в папке `diagrams` проекта
